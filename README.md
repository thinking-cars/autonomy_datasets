...
| [**TUM Traffic**](docs/IMPLEMENTATION.md#tum-traffic-dataset) | April 2022 | [![non-commercial](https://img.shields.io/badge/license-non--commercial-red)](https://creativecommons.org/licenses/by-nc-nd/4.0/) [![TUM Traffic Dataset](https://img.shields.io/badge/origin-TUM_Traffic_Dataset-green)](https://tum-traffic-dataset.github.io) | Germany (A9 motorway and S110 intersection near Munich) | Roadside infrastructure subsets (releases `R00` to `R02`) with up to 4 cameras and 2 lidars per sensor station | ![Rviz Screenshot TUM Traffic Dataset](./docs/assets/rviz_tum_traffic.png) |
